            ...
            <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                <div class="hero-content">
                    ...
                    <div class="btn-container">
                        <a href="{{ '/reports/daily/' | relative_url }}" class="btn btn-primary">查看今日日报</a>
                        <a href="{{ '#intelligence-overview' | relative_url }}" class="btn btn-outline-light">进入情报总览</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="kpi-card">
                    ...
                    <span class="kpi-badge info" style="background: rgba(6, 182, 212, 0.25); color: #06b6d4; border-color: rgba(6, 182, 212, 0.3);">
                        <i class="fas fa-chart-line"></i> {{ kpi.trend }}
                    </span>
                    {% elsif kpi.trendType == "down" %}
                    <span class="kpi-badge warning" style="background: rgba(245, 158, 11, 0.25); color: #f59e0b; border-color: rgba(245, 158, 11, 0.3);">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="report-card">
                            ...
                            <div class="report-meta">
                                {% for brand in post.brands limit:1 %}
                                <span class="brand-tag" style="background: rgba(247, 37, 133, 0.25); color: #f72585; border-color: rgba(247, 37, 133, 0.3);">{{ brand }}</span>
                                {% endfor %}
                                <span class="importance-badge {% if post.importance == 'high' %}high{% elsif post.importance == 'critical' %}critical{% endif %}">重要性: {% if post.importance == 'high' %}高{% elsif post.importance == 'critical' %}极高{% else %}中{% endif %}</span>
                            </div>
                            <a href="{{ post.url | relative_url }}" class="read-more">查看详情 <i class="fas fa-arrow-right"></i></a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="report-card">
                            ...
                            <div class="report-meta">
                                {% for brand in post.brands limit:1 %}
                                <span class="brand-tag" style="background: rgba(114, 9, 183, 0.25); color: #7209b7; border-color: rgba(114, 9, 183, 0.3);">{{ brand }}</span>
                                {% endfor %}
                                <span class="importance-badge {% if post.importance == 'high' %}high{% elsif post.importance == 'critical' %}critical{% endif %}">重要性: {% if post.importance == 'high' %}高{% elsif post.importance == 'critical' %}极高{% else %}中{% endif %}</span>
                            </div>
                            <a href="{{ post.url | relative_url }}" class="read-more">查看详情 <i class="fas fa-arrow-right"></i></a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="report-card">
                            ...
                            <div class="report-meta">
                                {% for brand in post.brands limit:1 %}
                                <span class="brand-tag" style="background: rgba(6, 214, 160, 0.25); color: #06d6a0; border-color: rgba(6, 214, 160, 0.3);">{{ brand }}</span>
                                {% endfor %}
                                <span class="importance-badge {% if post.importance == 'high' %}high{% elsif post.importance == 'critical' %}critical{% endif %}">重要性: {% if post.importance == 'high' %}高{% elsif post.importance == 'critical' %}极高{% else %}中{% endif %}</span>
                            </div>
                            <a href="{{ post.url | relative_url }}" class="read-more">查看详情 <i class="fas fa-arrow-right"></i></a>
